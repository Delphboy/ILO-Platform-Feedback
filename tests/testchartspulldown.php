...
<div class="sec-container">
    <!-- RAW DATA SHOWN HERE -->
    <div class="sec1 col-md-5 col-xs-12" >
        <?php
        /**
         * Created by PhpStorm.
         * User: sagiu
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
	<label> <select name="click" class="searchOp">
			<option value="select * from gr2.review;">View All Data</option>
	...
	<input type="submit" class="login100-form-btn" placeholder="GO" value="Input Country">
</form>

<div class="tablescroll">
	<?php
	echo "<table id='myTable' class='table table-striped col-md-5 col-xs-12'>";
...
<!-- INFOGRAPHICS SHOWN HERE -->
<div class="sec2 col-md-7 col-xs-12" >
	...
	<select name = "def-graphs" class = "searchOp">
		<option id = "placeholder" value = "placeholder">Choose graph</option>
		<option id = "graph1" value = "PlatformVSWage"
		        onclick = "platform_vs_wage()"> Platform by Avg wage barchart
		</option>
		<option id = "graph2" value = "WagePerCountry"
		        onclick = "wage_per_country()"> Avg Wage per country barchart
		</option>
		<option id = "graph3" value = "PlatformPopularity"
		        onclick = "platform_popularity()"> Platform popularity piechart
		</option>
		<option id = "graph4" value = "TimeVSTime"
		        onclick = "rating_vs_wage()">Scatter chart of time looking vs time working
		</option>
		<option id = "graph5" value = "PlatformByRating" onclick = "platform_by_rating()">Platform by Avg rating
		</option>
	</select>
